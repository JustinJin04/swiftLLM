...
def test_kernel(batch_size, infeatures, outfeatures, rounds):
...
def main():
    ...
    # parser.add_argument("--infeatures", type=int, default=4096, help="Input features")
    # parser.add_argument("--outfeatures", type=int, default=14336*2, help="Output features") 
    test_kernel(1, 14336*2, 4096, 1)
    test_kernel(1, 4096, 14336, 1)
    test_kernel(1, 6144, 4096, 1)
    test_kernel(1, 4096, 4096, 1)
